...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: PlumberListScreen(), // ✅ Plumber Worker List Screen
    );
  }
}

class PlumberListScreen extends StatefulWidget {
  @override
...
class _PlumberListScreenState extends State<PlumberListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          CustomAppBar(title: "Plumber"), // ✅ Updated App Bar
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('workerregister')
                  .where('jobTitle', isEqualTo: 'Plumber') // ✅ Only Plumbers
                  .snapshots(),
