...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ElectronicsListScreen(), // ✅ Electronics Worker List Screen
    );
  }
}
...
class _ElectronicsListScreenState extends State<ElectronicsListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          CustomAppBar(title: "Electronics"), // ✅ Updated App Bar
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('workerregister')
                  .where('jobTitle', isEqualTo: 'Electronics') // ✅ Only Electronics Workers
                  .snapshots(),
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return Center(child: Text("No electronics workers found"));
                }
