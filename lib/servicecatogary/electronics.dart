...
class ElectronicsListScreen extends StatefulWidget {
  @override
  _ElectronicsListScreenState createState() => _ElectronicsListScreenState();
}
            ...
            child: InkWell(
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => BookingPage(
                      ...
                      name: worker['name'] ?? 'Electronics Technician',
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      worker['name'] ?? 'Electronics Technician',
                    ...
                    _buildInfoRow(Icons.electrical_services, 'Service', worker['jobTitle'] ?? 'Electronics Service'),
                      ...
                      child: Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: "Search electronics services...",
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              "Error loading electronics services",
                              style: GoogleFonts.poppins(
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 20),
                        Text(
                          'No electronics technicians available',
                          style: GoogleFonts.poppins(
                            fontSize: 20,
                            fontWeight: FontWeight.w500,
                            color: Colors.grey,
