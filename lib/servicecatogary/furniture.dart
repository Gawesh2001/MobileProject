...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: FurnitureListScreen(), // ✅ Furniture Worker List Screen
    );
  }
}
...
class _FurnitureListScreenState extends State<FurnitureListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          CustomAppBar(title: "Furniture"), // ✅ Updated App Bar
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('workerregister')
                  .where('jobTitle', isEqualTo: 'Furniture') // ✅ Only Furniture Workers
                  .snapshots(),
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return Center(child: Text("No furniture workers found"));
                }
