...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: CleanerListScreen(), // ✅ Cleaner Worker List Screen
    );
  }
}
...
class _CleanerListScreenState extends State<CleanerListScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          CustomAppBar(title: "Cleaner"), // ✅ Updated App Bar
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('workerregister')
                  .where('jobTitle', isEqualTo: 'Cleaner') // ✅ Only Cleaners
                  .snapshots(),
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return Center(child: Text("No cleaners found"));
                }
